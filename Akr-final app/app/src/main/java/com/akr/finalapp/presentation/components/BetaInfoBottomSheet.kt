...
fun BetaInfoBottomSheet(modifier: Modifier = Modifier) {
    ...
    val issuesUrl = "https://github.com/ajaykumarreddy-k/AKR-PixelPlayer/issues"
    val reportUrl = "https://github.com/ajaykumarreddy-k/AKR-PixelPlayer/issues/new/choose"
