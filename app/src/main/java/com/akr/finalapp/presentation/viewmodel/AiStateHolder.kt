...
import com.akr.finalapp.data.ai.AiMetadataGenerator
...
import com.akr.finalapp.data.ai.provider.AiProviderException
...
class AiStateHolder @Inject constructor(
    ...
    private val aiOrchestrator: com.akr.finalapp.data.ai.AiOrchestrator
) {
    // State
