...
import com.akr.finalapp.data.backup.BackupManager
...
import com.akr.finalapp.data.backup.model.RestoreResult
import com.akr.finalapp.data.backup.model.ValidationError
...
import com.akr.finalapp.data.database.AiUsageEntity
...
import com.akr.finalapp.data.ai.GeminiModel
import com.akr.finalapp.data.ai.provider.AiClientFactory
import com.akr.finalapp.data.ai.provider.AiProvider
import com.akr.finalapp.data.preferences.LaunchTab
import com.akr.finalapp.data.model.Song
import com.akr.finalapp.data.service.player.HiFiCapabilityChecker
...
class SettingsViewModel @Inject constructor(
    ...
    private val geminiModelService: com.akr.finalapp.data.ai.GeminiModelService,
            ...
            try {
                ...
                val models = if (provider == AiProvider.GEMINI) {
                    ...
                    aiClient.getAvailableModels(apiKey)
                        ...
                        .distinct()
                        .map { com.akr.finalapp.data.ai.GeminiModel(it, formatModelDisplayName(it)) }
                }
    ...
    fun setAlbumArtCacheLimitMb(limitMb: Int) {
        viewModelScope.launch {
            ...
            com.akr.finalapp.utils.AlbumArtCacheManager.configuredCacheLimitMb = limitMb.toLong()
        }
    }
