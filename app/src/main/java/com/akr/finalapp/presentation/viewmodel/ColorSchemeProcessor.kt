...
import com.akr.finalapp.data.database.AlbumArtThemeEntity
import com.akr.finalapp.data.database.StoredColorSchemeValues
import com.akr.finalapp.data.database.toComposeColor
import com.akr.finalapp.utils.LocalArtworkUri
import com.akr.finalapp.ui.theme.clearExtractedColorCache
import com.akr.finalapp.ui.theme.extractSeedColor
import com.akr.finalapp.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.akr.finalapp.ui.theme.ColorExtractionConfig(
