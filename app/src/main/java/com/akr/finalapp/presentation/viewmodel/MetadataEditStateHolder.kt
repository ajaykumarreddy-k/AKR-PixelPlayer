...
import com.akr.finalapp.data.media.ImageCacheManager
import com.akr.finalapp.data.media.MetadataEditError
...
import com.akr.finalapp.utils.FileDeletionUtils
import com.akr.finalapp.utils.LyricsUtils
import com.akr.finalapp.utils.MediaItemBuilder
import com.akr.finalapp.utils.MediaStorePermissionHelper
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.akr.finalapp.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
