...
interface MusicRepository {
    ...
    fun getPaginatedAlbums(
        ...
        storageFilter: com.akr.finalapp.data.model.StorageFilter = com.akr.finalapp.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.akr.finalapp.data.model.SortOption = com.akr.finalapp.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.akr.finalapp.data.model.StorageFilter = com.akr.finalapp.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.akr.finalapp.data.model.SortOption = com.akr.finalapp.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.akr.finalapp.data.model.StorageFilter = com.akr.finalapp.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.akr.finalapp.data.model.SortOption = com.akr.finalapp.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.akr.finalapp.data.model.StorageFilter = com.akr.finalapp.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.akr.finalapp.data.model.SortOption = com.akr.finalapp.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.akr.finalapp.data.model.StorageFilter = com.akr.finalapp.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.akr.finalapp.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.akr.finalapp.data.model.StorageFilter = com.akr.finalapp.data.model.StorageFilter.ALL
    ): Flow<List<com.akr.finalapp.data.model.MusicFolder>>
    ...
    suspend fun saveTelegramTopics(chatId: Long, topics: List<com.akr.finalapp.data.database.TelegramTopicEntity>)
    /** Replaces the full topic list for a channel, deleting any topics that no longer exist. */
    suspend fun replaceTopicsForChannel(chatId: Long, freshTopics: List<com.akr.finalapp.data.database.TelegramTopicEntity>)
    suspend fun getTopicsForChannel(chatId: Long): List<com.akr.finalapp.data.database.TelegramTopicEntity>
    fun getAllTelegramTopics(): Flow<List<com.akr.finalapp.data.database.TelegramTopicEntity>>
    suspend fun replaceTelegramSongsForTopic(chatId: Long, threadId: Long, topicName: String, songs: List<Song>)

    val telegramRepository: com.akr.finalapp.data.telegram.TelegramRepository
