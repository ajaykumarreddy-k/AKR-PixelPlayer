...
import com.akr.finalapp.shared.WearLyrics
...
class WearStatePublisher @Inject constructor(
    ...
    private fun resolveArtworkBytesForWear(playerInfo: PlayerInfo): ByteArray? {
        ...
        if (!uriString.isNullOrBlank()) {
            ...
            when {
                com.akr.finalapp.utils.LocalArtworkUri.isLocalArtworkUri(uriString) ||
                    scheme == "content" ||
                    scheme == "file" ||
    ...
    private fun com.akr.finalapp.data.model.Lyrics.toWearLyrics(
