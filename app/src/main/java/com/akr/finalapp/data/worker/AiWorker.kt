...
import com.akr.finalapp.data.ai.AiNotificationManager
import com.akr.finalapp.data.ai.AiOrchestrator
import com.akr.finalapp.data.ai.AiSystemPromptType
import com.akr.finalapp.data.ai.UserProfileDigestGenerator
...
class AiWorker @AssistedInject constructor(
    ...
    private val preferencesRepo: com.akr.finalapp.data.preferences.AiPreferencesRepository
