package com.akr.finalapp.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.akr.finalapp.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.akr.finalapp.data.remote.qqmusic.QQSignGenerator(context)
        ))
