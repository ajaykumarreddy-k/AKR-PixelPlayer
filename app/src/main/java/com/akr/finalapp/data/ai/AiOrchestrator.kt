...
import com.akr.finalapp.data.database.AiCacheEntity
...
class AiOrchestrator @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        return try {
            ...
            throw com.akr.finalapp.data.ai.provider.AiProviderSupport.createException(
            ...
            val failure = com.akr.finalapp.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.akr.finalapp.data.ai.provider.AiClient,
        failure: com.akr.finalapp.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.akr.finalapp.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val providersToTry = com.akr.finalapp.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.akr.finalapp.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
