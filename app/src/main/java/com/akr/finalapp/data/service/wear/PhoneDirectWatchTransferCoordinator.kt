package com.akr.finalapp.data.service.wear
...
import com.akr.finalapp.data.gdrive.GDriveStreamProxy
...
import com.akr.finalapp.data.telegram.TelegramStreamProxy
import com.akr.finalapp.presentation.viewmodel.ColorSchemeProcessor
import com.akr.finalapp.shared.WearDataPaths
import com.akr.finalapp.shared.WearThemePalette
import com.akr.finalapp.shared.WearTransferMetadata
import com.akr.finalapp.shared.WearTransferProgress
import com.akr.finalapp.shared.WearTransferRequest
...
class PhoneDirectWatchTransferCoordinator @Inject constructor(
    ...
    private suspend fun ensureCloudProxyReady(proxy: Any): Boolean {
        return when (proxy) {
            ...
            is com.akr.finalapp.data.jellyfin.JellyfinStreamProxy -> proxy.ensureReady(5_000L)
            else -> false
        }
    }
