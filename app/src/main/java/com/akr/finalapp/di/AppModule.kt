...
import com.akr.finalapp.BuildConfig
import com.akr.finalapp.PixelPlayApplication
import com.akr.finalapp.data.database.AlbumArtThemeDao
import com.akr.finalapp.data.database.EngagementDao
import com.akr.finalapp.data.database.FavoritesDao
import com.akr.finalapp.data.database.GDriveDao
import com.akr.finalapp.data.database.LyricsDao
import com.akr.finalapp.data.database.AiCacheDao
import com.akr.finalapp.data.database.AiUsageDao
import com.akr.finalapp.data.database.LocalPlaylistDao
import com.akr.finalapp.data.database.MusicDao
import com.akr.finalapp.data.database.PixelPlayDatabase
import com.akr.finalapp.data.database.SearchHistoryDao
import com.akr.finalapp.data.database.TransitionDao
...
import com.akr.finalapp.data.preferences.dataStore
import com.akr.finalapp.data.media.SongMetadataEditor
import com.akr.finalapp.data.network.deezer.DeezerApiService
import com.akr.finalapp.data.network.netease.NeteaseApiService
import com.akr.finalapp.data.network.lyrics.LrcLibApiService
import com.akr.finalapp.data.repository.ArtistImageRepository
import com.akr.finalapp.data.repository.LyricsRepository
import com.akr.finalapp.data.repository.LyricsRepositoryImpl
import com.akr.finalapp.data.repository.MediaStoreSongRepository
import com.akr.finalapp.data.repository.MusicRepository
import com.akr.finalapp.data.repository.MusicRepositoryImpl
import com.akr.finalapp.data.repository.SongRepository
import com.akr.finalapp.data.repository.TransitionRepository
import com.akr.finalapp.data.repository.TransitionRepositoryImpl
import com.akr.finalapp.data.repository.FolderTreeBuilder
...
object AppModule {
    ...
    fun provideSessionToken(@ApplicationContext context: Context): androidx.media3.session.SessionToken {
        return androidx.media3.session.SessionToken(
            context,
            android.content.ComponentName(context, com.akr.finalapp.data.service.MusicService::class.java)
        )
    }
    ...
    @Singleton
    @Provides
    fun provideQqMusicDao(database: PixelPlayDatabase): com.akr.finalapp.data.database.QqMusicDao {
        return database.qqmusicDao()
    }

    @Singleton
    @Provides
    fun provideNavidromeDao(database: PixelPlayDatabase): com.akr.finalapp.data.database.NavidromeDao {
    ...
    @Singleton
    @Provides
    fun provideJellyfinDao(database: PixelPlayDatabase): com.akr.finalapp.data.database.JellyfinDao {
    ...
    fun provideSongRepository(
        @ApplicationContext context: Context,
        mediaStoreObserver: com.akr.finalapp.data.observer.MediaStoreObserver,
    ...
    @Singleton
    @Provides
    fun provideTelegramDao(database: PixelPlayDatabase): com.akr.finalapp.data.database.TelegramDao {
        return database.telegramDao()
    }

    @Singleton
    @Provides
    fun provideNeteaseDao(database: PixelPlayDatabase): com.akr.finalapp.data.database.NeteaseDao {
    ...
    fun provideMusicRepository(
        ...
        telegramDao: com.akr.finalapp.data.database.TelegramDao,
        telegramCacheManager: Lazy<com.akr.finalapp.data.telegram.TelegramCacheManager>,
        telegramRepository: Lazy<com.akr.finalapp.data.telegram.TelegramRepository>,
