...
import com.akr.finalapp.data.database.SongEntity // Necesario para datos de prueba
import com.akr.finalapp.data.database.AlbumEntity
import com.akr.finalapp.data.database.ArtistEntity
import com.akr.finalapp.data.model.Song // Para verificar el mapeo
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.akr.finalapp.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.akr.finalapp.data.telegram.TelegramRepository = mockk(relaxed = true)
    private val mockTelegramCacheManagerProvider: Lazy<com.akr.finalapp.data.telegram.TelegramCacheManager> = mockk()
    private val mockTelegramRepositoryProvider: Lazy<com.akr.finalapp.data.telegram.TelegramRepository> = mockk()
